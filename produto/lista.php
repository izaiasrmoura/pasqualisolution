...
$sql  = " SELECT p.cod_produto, p.descricao produto, c.descricao categoria ";
$sql .= " FROM produto p INNER JOIN categoria c ON(c.cod_categoria=p.cod_categoria) ";
    ...
    <tr> 
      <td colspan="3" align="center" valign="top"> <table width="100%" border="0" cellspacing="2" cellpadding="0" align="center">
          <tr> 
            ...
            <td width="48" align="center" class="adm-tit12-center">Categoria</td>
...
?>
          <tr>
<td  style="cursor:pointer" class="adm-txt12-left" title='Editar' onClick="location='cadastro.php?act=editar&cod=<?php print $dados->cod_produto?>&rnd=<?=rnd?>'">
<?php print $dados->produto ?></td>
<td  style="cursor:pointer" class="adm-txt12-left" title='Editar' onClick="location='cadastro.php?act=editar&cod=<?php print $dados->cod_produto?>&rnd=<?=rnd?>'">
<?php print $dados->categoria ?></td>

<td align="center" class="adm-txt12-center" >
  <img src="../img/excluir.gif" width="16" height="16" style="cursor:pointer" alt="Excluir" title='Excluir' onClick="fRemover(<?php print $dados->cod_produto?>)"  border="0"></td>
          </tr>
<?php
}
?>
          <tr> 
            <td colspan="3" class="adm-txt12-left">&nbsp;</td>
          </tr>
        </table></td>
    </tr>
  </table>
